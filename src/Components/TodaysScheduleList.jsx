...
const TodaysScheduleList = ({editingMode,positivePage,cust_data,fetchCustomer,isLoadingState}) => {
    ...
    <div className="container mx-auto">
      ...
      <div className="mt-8 overflow-auto min-h-96">
        <div className='flex justify-between items-center'>
            ...
            <div className='mb-4'>
              <h2 className="text-xl font-bold">Todays Schedule List</h2>
            ...
            <div className='flex items-center space-x-1'>
                ...
                <p className={`cursor-pointer hidden px-2 text-white py-1 bg-red-500 rounded-md text-xs`} onClick={()=>{fetchCustomer();setisPositiveFilter(false);setselectedsectors('')}}><FontAwesomeIcon icon={faClone} /> Clear Filter</p>
                ...
                <select  onChange={(e)=>setselectedsectors(e.target.value)} defaultValue={selectedsectors} className='p-1 hidden rounded-md '>
        ...
        <table className="min-w-full min-h-14 bg-white dark:bg-gray-800 shadow-md rounded-md">
          ...
          <tbody>
            ...
            {(
                ...
                <tr key={index} className={`text-left ${customer?.positive!=='Yes'&&"bg-green-100"}`}>
                  ...
                  <td className="py-2 px-4 border-b text-sm">
                    ...
                    <p className='text-gray-100 bg-red-500 w-fit'>{moment(customer?.meeting_time).fromNow()}</p>
                  </td>
                  <td className="py-2 px-4 border-b text-sm">
                  ...
                  <td className="py-2 hidden px-4 border-b text-sm space-x-2">
...
export default TodaysScheduleList;
