...
const NotificationssList = ({editingMode,positivePage,cust_data,fetchCustomer,isLoadingState}) => {
        ...
        <table className="min-w-full min-h-14 bg-white dark:bg-gray-800 shadow-md rounded-md">
          <thead>
            <tr className='text-left'>
              ...
              <th className="py-2 px-4 border-b text-sm">Notif. Time</th>
...
export default NotificationssList;
