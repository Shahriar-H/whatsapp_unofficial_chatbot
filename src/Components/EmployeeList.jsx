...
const EmployeeList = ({editingMode,positivePage,cust_data,fetchCustomer,isLoadingState}) => {
  ...
  const deleteData = async (id)=>{
    await delete_item({id,table:"employees"})
    fetchCustomer()
  }
  ...
  const updateState =async (value,id)=>{
    ...
    await update_item({data,table:"employees",id})
    setTimeout(() => {
        if(positivePage){
      ...
      <div className="mt-8 overflow-auto min-h-96">
        <div className='flex justify-between items-center'>
            ...
            <div className='mb-4'>
              ...
              <div className='hidden space-x-1 items-center'>
        ...
        <table className="min-w-full min-h-14 bg-white dark:bg-gray-800 shadow-md rounded-md">
          <thead>
            <tr className='text-left'>
              ...
              <th className="py-2 px-4 border-b text-sm">Employee Name</th>
              <th className="py-2 px-4 border-b text-sm">Designation</th>
              <th className="py-2 px-4 border-b text-sm">Phone Number</th>
              <th className="py-2 px-4 border-b text-sm">Email</th>
              <th className="py-2 px-4 hidden border-b text-sm">Status</th>
          ...
          <tbody>
            ...
            {(
                ...
                <tr key={index} className='text-left'>
                  ...
                  <td className="py-2 px-4 border-b text-sm">{customer.designation}</td>
                  ...
                  <td className="py-2 px-4 border-b text-sm space-x-2">
                    ...
                    {instancedata?.login_info?.role==='Supper'&&<>
